...
seg_model.train(data='/home/enflame/OCR_IND/API_issue/datasets/segmentation/data.yaml', task='detect', epochs=50, imgsz=640, batch=8, patience=10, name='yolo_seg', project= '/home/enflame/OCR_IND/train_models')
...
seg_model = YOLO('/home/enflame/OCR_IND/train_models/yolo_seg/weights/best.pt')
results_seg = seg_model.predict(source='/home/enflame/OCR_IND/API_issue/test_invoice.png', save=True)

det_model = YOLO('/home/enflame/OCR_IND/train_models/yolo_det/weights/best.pt')
